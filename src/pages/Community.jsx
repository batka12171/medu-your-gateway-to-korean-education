          ...
          <TabsContent value="discussions" className="space-y-6">
            <div className="flex justify-between items-center">
              ...
              <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogTrigger asChild>
                  <Button className="bg-[#ff7300] hover:bg-[#cc5c00]">
            ...
            <DialogContent className="sm:max-w-lg">
              ...
              <form onSubmit={handleCreatePost} className="space-y-4 mt-4">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-[#ff7300] hover:bg-[#cc5c00]"
            ...
            {filteredPosts.map((post, index) => (
              ...
              >
                    ...
                    <div className="flex gap-3 items-start">
                      ...
                      <div className="flex flex-col items-center gap-1 pt-1">
                        <button 
                          ...
                          className="p-1 hover:bg-[#ff7300]/10 rounded transition-colors"
                        >
                          <svg className="w-5 h-5 text-slate-400 hover:text-[#ff7300]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 15l7-7 7 7" />
                          </svg>
                        </button>
                        <span className="text-sm font-semibold text-[#ff7300]">{post.likes_count || 0}</span>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h3 className="text-lg font-semibold text-slate-900 mb-2 hover:text-[#ff7300] cursor-pointer">
                          {post.title}
                        </h3>
                ...
                <form onSubmit={(e) => { e.preventDefault(); if (user) createGroupMutation.mutate(newGroup); else base44.auth.redirectToLogin(); }} className="space-y-4">
                 ...
                 <Button type="submit" className="w-full bg-[#ff7300] hover:bg-[#cc5c00]">Create Group</Button>
                </form>
                </DialogContent>
                </Dialog>
                </div>
                ...
                <DialogTrigger asChild>
                <Button className="bg-[#ff7300] hover:bg-[#e06e46]">
                  <Plus className="w-4 h-4 mr-2" />
                  Create Event
                </Button>
                </DialogTrigger>
                ...
                <form onSubmit={(e) => { e.preventDefault(); if (user) createEventMutation.mutate(newEvent); else base44.auth.redirectToLogin(); }} className="space-y-4">
                 ...
                 <Button type="submit" className="w-full bg-[#ff7300] hover:bg-[#e06e46]">Create Event</Button>
                </form>
                </DialogContent>
                </Dialog>
                </div>
                ...
                <form onSubmit={(e) => { e.preventDefault(); if (user) createQuestionMutation.mutate(newQuestion); else base44.auth.redirectToLogin(); }} className="space-y-4">
                 ...
                 <Button type="submit" className="w-full bg-[#ff7300] hover:bg-[#cc5c00]">Post Question</Button>
                </form>
                </DialogContent>
                </Dialog>
                </div>
                ...
                <div className="flex items-start justify-between mb-3">
                 <div className="flex-1">
                   ...
                   <div className="flex items-center gap-3 text-sm text-slate-500">
                     <Badge className="bg-[#ff7300]/10 text-[#ff7300]">{q.category}</Badge>
                ...
                <Button size="sm" variant="outline" onClick={() => setSelectedQuestion(q)} className="border-[#ff7300] text-[#ff7300]">View Answers</Button>
                {selectedQuestion?.id === q.id && (
                 <div className="mt-4 pt-4 border-t space-y-4">
                       ...
                       <div className="flex items-start gap-3">
                         ...
                         <div className="flex-1">
                           <div className="flex items-center gap-2 mb-2">
                             ...
                             {a.is_mentor && <Badge className="bg-[#ff7300] text-white text-xs">Mentor</Badge>}
                   ...
                   <form onSubmit={(e) => { e.preventDefault(); if (user) createAnswerMutation.mutate({ question_id: q.id, content: newAnswer, author_name: user.full_name || "Anonymous", author_email: user.email }); else base44.auth.redirectToLogin(); }} className="flex gap-2">
                     ...
                     <Button type="submit" className="bg-[#ff7300] hover:bg-[#cc5c00]">Answer</Button>
                   </form>
                 </div>
                )}
                </div>
