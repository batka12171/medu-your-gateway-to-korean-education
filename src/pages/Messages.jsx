                  ...
                  <button
                    ...
                    className={`w-full text-left p-3 rounded-lg transition-all ${
                      selectedConversation?.id === conv.id 
                        ? 'bg-[#4A90C5]/10 border border-[#4A90C5]' 
                        : 'hover:bg-slate-50 border border-transparent'
                    }`}
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#4A90C5] to-[#357AB8] flex items-center justify-center text-white font-semibold">
                        {conv.otherName?.[0] || 'U'}
                      </div>
              ...
              <>
                ...
                <form onSubmit={handleSend} className="p-4 border-t border-slate-100">
                  <div className="flex gap-2">
                    ...
                    />
                    <Button type="submit" className="bg-[#4A90C5] hover:bg-[#357AB8]">
