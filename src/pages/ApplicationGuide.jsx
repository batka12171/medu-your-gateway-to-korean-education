            ...
            {activeView === "dashboard" ? (
              ...
              <div className="min-h-full">
                ...
                <div className="max-w-2xl mt-8">
                  {activeAppSection === "profile" && <ProfileSection />}
                  {activeAppSection === "family" && <FamilySection />}
                  {activeAppSection === "education" && <EducationSection />}
                  {activeAppSection === "testing" && <TestingSection />}
                  {activeAppSection === "activities" && <ActivitiesSection />}
                  {activeAppSection === "additional_documents" && <AdditionalDocumentsSection />}
                </div>
              </div>
            ) : (
              <div className="min-h-full">
