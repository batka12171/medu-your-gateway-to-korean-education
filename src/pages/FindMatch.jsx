      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {!activeMatch && !isMatching && (
          <div className="bg-white rounded-2xl border border-slate-100 p-12 text-center">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#2D3561] to-[#1a1f3a] flex items-center justify-center mx-auto mb-6">
            ...
            <Button 
              ...
              size="lg"
              className="bg-[#F4845F] hover:bg-[#e06e46] text-white"
            >
        ...
        {isMatching && (
          <motion.div
            ...
            className="bg-gradient-to-br from-[#2D3561] to-[#1a1f3a] rounded-2xl border border-slate-100 p-12 text-center relative overflow-hidden"
          >
        ...
        {activeMatch && (
          ...
          >
            ...
            <motion.div
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              className="bg-gradient-to-r from-[#F4845F] to-[#D4A574] rounded-2xl p-6 text-center relative overflow-hidden"
            >
            ...
            {matchedUserProfile && (
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#2D3561] to-[#1a1f3a] flex items-center justify-center text-white text-2xl font-bold">
                  ...
                  <div className="flex-1">
                    ...
                    {matchedUserProfile.student_status && (
                      <Badge className="mt-1 bg-[#2D3561]/10 text-[#2D3561]">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden">
              {/* Chat Header */}
              <div className="bg-gradient-to-r from-[#2D3561] to-[#1a1f3a] p-4 flex items-center justify-between">
            ...
            <form onSubmit={handleSendMessage} className="p-4 border-t border-slate-200">
              <div className="flex gap-2">
                ...
                <Button 
                  ...
                  className="bg-[#2D3561] hover:bg-[#1a1f3a]"
                >
            ...
            <div className="text-center">
              <Button 
                ...
                className="border-[#F4845F] text-[#F4845F] hover:bg-[#F4845F]/5"
              >
