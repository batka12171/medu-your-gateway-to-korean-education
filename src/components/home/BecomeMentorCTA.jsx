  ...
  return (
    <section className="py-24 bg-slate-50 relative z-10">
      <div className="max-w-5xl mx-auto px-4">
        <div className="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-[3rem] p-10 md:p-16 text-center text-white relative overflow-hidden shadow-2xl shadow-emerald-600/20">
          ...
          <div className="relative z-10">
            ...
            <Link to={createPageUrl("BecomeMentor")}>
              <button className="px-8 py-4 bg-white text-emerald-700 hover:bg-slate-50 rounded-full font-bold text-lg transition-all shadow-xl shadow-black/10 flex items-center justify-center gap-2 mx-auto">
