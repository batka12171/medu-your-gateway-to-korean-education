    ...
    <div className="relative min-h-[100vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div 
          ...
          className="absolute top-1/4 left-1/4 w-2 h-2 bg-[#38d9c0] rounded-full blur-sm"
        />
        <motion.div 
          animate={{ y: [0, 20, 0] }}
        ...
        <motion.div 
          ...
          className="absolute bottom-1/3 left-1/3 w-2 h-2 bg-[#00C9A7] rounded-full blur-sm"
        />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white text-sm mb-8">
            <Sparkles className="w-4 h-4 text-[#38d9c0]" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to={createPageUrl("Universities")}>
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-[#005F56] to-[#00C9A7] hover:from-[#004d47] hover:to-[#00a88c] text-white px-8 py-6 text-lg rounded-xl shadow-2xl shadow-[#00C9A7]/30 transition-all"
              >
