    ...
    <section className="py-24 bg-slate-50 border-y border-slate-100 relative z-10">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="text-emerald-600 font-semibold tracking-wide uppercase text-sm mb-3">University Applications</div>
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-tr from-emerald-200 to-teal-100 rounded-[3rem] transform rotate-3 scale-105 opacity-50 z-0" />
