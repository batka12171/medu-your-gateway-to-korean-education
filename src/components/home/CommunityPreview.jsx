        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              ...
              <br />
              <span className="text-[#ff7300]">who've been there</span>
            </h2>
            ...
            <Link to={createPageUrl("Community")}>
              <Button size="lg" className="bg-[#ff7300] hover:bg-[#cc5c00]">
            ...
            {posts.map((post, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#ff7300] to-[#cc5c00] flex items-center justify-center text-white font-medium">
                    {post.author[0]}
                  </div>
