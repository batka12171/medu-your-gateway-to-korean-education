        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              ...
              <br />
              <span className="text-orange-500">who've been there</span>
            </h2>
          ...
          >
            {posts.map((post, index) => (
              <motion.div
                ...
                className="bg-white rounded-xl border border-slate-100 p-5 hover:shadow-lg hover:border-orange-200 transition-all duration-300"
              >
