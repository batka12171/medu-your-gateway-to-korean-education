        ...
        <div className="grid md:grid-cols-3 gap-12 relative">
          ...
          {steps.map((s, i) => (
            <div key={i} className="relative z-10 flex flex-col items-center">
              <div className="w-24 h-24 bg-white border-4 border-slate-50 shadow-xl shadow-orange-900/5 rounded-full flex items-center justify-center text-2xl font-black text-orange-600 mb-6">
                {s.num}
              </div>
